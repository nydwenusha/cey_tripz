...
--   2. Import this file into that selected database.
--   3. Do not import this into a database that already contains data unless you intend to replace it.
...
-- Mark the Laravel migrations represented by this final schema as already applied.
-- This prevents a later `php artisan migrate` from trying to recreate tables that this file already created.
...
VALUES
    ...
    ('2026_02_10_153738_add_fields_to_users_table', 1),
    ('2026_02_11_200802_create_bookings_table', 1),
    ('2026_03_24_060207_create_blog_posts_table', 1),
    ('2026_03_24_072143_create_tags_table', 1),
    ('2026_03_24_072409_create_blo_post_tag_table', 1),
    ('2026_03_24_074026_rename_blo_post_tag_to_blog_post_tag', 1),
    ('2026_03_24_090029_create_blog_post_categories_table', 1),
    ('2026_03_24_090943_add_category_id_to_blog_posts_table', 1),
    ('2026_03_27_045731_add_excerpt_to_blog_posts_table', 1),
    ('2026_04_12_120000_add_completed_status_to_bookings_table', 1),
